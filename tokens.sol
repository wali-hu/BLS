...
contract stBLSToken is ERC20 {
    address public immutable blsStaking;

    constructor(address _BLSStaking) ERC20("stBLSToken", "stBLS") {
        blsStaking = _BLSStaking;
    }

    function mint(address to, uint256 _amount) external {
        require(msg.sender == blsStaking, "You are not allowed");
        _mint(to, _amount);
    }
